    ...
    const handleSubmitOrder = async () => {
        ...
        try {
            const orderData = {
                ...
                ocpId: formData.deliveryMethod === "pickup" ? formData.pickupPoint : null,
                                ...
                                <>
                                                ...
                                                <Radio value="pickup">
                                                    <div className={styles.methodContent}>
                                                        ...
                                                        <div>
                                                            ...
                                                            <Text type="secondary">
                                                                Заберите заказ из пункта выдачи
                                                            </Text>
                                                        </div>
                                                    </div>
                                                </Radio>
                                    ...
                                    {formData.deliveryMethod === "pickup" && (
                                        <>
                                            ...
                                            <div className={errors.pickupPoint ? styles.errorField : ""}>
                                                <Radio.Group
                                                    className={styles.pickupPoints}
                                                ...
                                                >
                                                    {ocpStore.ocpList.map(ocp => (
                                                        <Card
                                                            ...
                                                            onClick={() => handleInputChange("pickupPoint", ocp.id)}
                                                        >
                                                            <Radio value={ocp.id}>
                                                                <div className={styles.pickupContent}>
                                                                    <Title level={4}>{ocp.address}</Title>
                                                                </div>
                                                            </Radio>
                                                        </Card>
                                                    ))}
                                        ...
                                        <div className={styles.summaryItem}>
                                            {formData.deliveryMethod === "pickup" ? (
                                                <>
                                                    ...
                                                    <Text>
                                                        Самовывоз из{" "}
                                                        {ocpStore.ocpList.find(
                                                            ocp => ocp.id === formData.pickupPoint
                                                        )?.address}
                                                    </Text>
                                                </>
                                            ) : (
